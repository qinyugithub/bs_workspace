...
var MessageController = function(){
	...
	var service = new MessageService(model);
	

	this.init = function(){     //初始化消息界面
	...
	this.openmessagebox=function(){  //点击显示消息框
		  var layim = layui.layim;
		layui.use('layim', function(){
		     layim.chat({
			        name: '小闲'
...
$(function(){
	...
	$("#showmessage").on('click',function(){
		...
		controller.openmessagebox();
	});
	
	$("#deletebton").on('click',function(){
		$.ajax({
			  type: 'POST',
			  url: "../delete.do",
			  data: null,
